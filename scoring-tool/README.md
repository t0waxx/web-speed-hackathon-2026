...
```bash
bun run start --applicationUrl <applicationUrl>
```
...
```shell
bun run start --applicationUrl <applicationUrl> --targetName
```
...
```shell
bun run start --applicationUrl <applicationUrl> --targetName "投稿"
```
